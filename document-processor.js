class DocumentProcessor {
  ...
  async processPDF(file) {
    try {
      // Asegurarse de que pdfjsLib esté disponible
      if (!window.pdfjsLib) {
        console.log("Cargando PDF.js...");
        // Usar la versión de pdfjs-dist en lugar de pdf.js
  ...
  updateProgress(message) {
    ...
    console.log(message);
    // Aquí podrías actualizar un elemento de la UI para mostrar el progreso
